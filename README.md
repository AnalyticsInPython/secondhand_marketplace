...
| **Data & analysis** | Kobe | The seed generator, the `listing_views`, `filter_events` and `enquiries` pipelines, and the questions in `app/analytics/`. |
...
actions (sold / reserved / relist / take down), saves, profile with my listings
and saved items, sign-out and deactivation. 59 backend tests, including the
disclosure test.
